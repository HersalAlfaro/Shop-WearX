...
<body class="animsition">
    ...
    <div class="page-wrapper">
        ...
        <div class="page-content--bgf7">
            ...
            <div class="content-wrapper">
                ...
                <div class="container flex-grow-1 container-p-y">
                    ...
                    <div class="container" id="listaEmpleados">
                        <h3 class="title-5 m-b-35">Lista Empleados</h3>
                        <div class="table-data__tool">
                            <div class="table-data__tool-right">
                                <?php
                                include 'fragments/agregarEmpleado.php'
                                ?>
                            </div>
                        </div>
                        <div class="card">
                            <div class="card-datatable table-responsive">
                                <table class="datatables-basic table border-top" id="lista-Empleados">
                                    <thead>
                                        <tr>
                                            <th>Cedula</th>
                                            <th>Nombre</th>
        ...
        <script src="dist/js/empleadosAdmin.js"></script>
